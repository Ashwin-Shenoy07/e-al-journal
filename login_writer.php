...
<div class="form">
  ...
  <form style="margin-block-start: 20px;display: flex;align-content: center;flex-direction: column;" method="post" action="writerLogin.php">
	...
	<p class="message" style="color: #636663;text-align: center;font-size: 16px;"> Not registered? <a style="display: inline-block;width: 100px;text-align: center;padding: 3px 0;color:#1a2238;" href="writer_reg.php">Sign Up</a></p>
  </form>
</div> 
</body>
</html>